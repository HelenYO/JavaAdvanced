...
public class StudentDB implements StudentGroupQuery {
    ...
    @Override
    public Set<String> getDistinctFirstNames(List<Student> students) {//todo::
    ...
    private Stream<Entry<String, List<Student>>> getAnyGroupsStream(Collection<Student> students, Supplier<Map<String, List<Student>>> mapSupplier) {//todo:: aaaa
